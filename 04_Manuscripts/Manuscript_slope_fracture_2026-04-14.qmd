...
We conducted a nationwide ecological study using 47 Japanese prefectures as the unit of analysis. Fracture surgery rates (per 100,000 population) were derived from the **10th National Database (NDB) Open Data** (**Reiwa 5** health insurance claims: April 2023 through March 2024). Terrain slope was calculated from 10-m resolution digital elevation model (DEM) data provided by the Geospatial Information Authority of Japan, weighted by habitable land area to reflect residential exposure. The proportion of individuals with fast walking speed was obtained from **Reiwa 4** (April 2022 through March 2023) Specific Health Checkup tabulations in the same release. We fit multivariable linear regression models adjusting for aging rate (proportion aged ≥65 years), fast walking rate, and population density.
...
We conducted a nationwide ecological study in which the Japanese prefecture (N = 47) served as the unit of analysis. Prefecture-level aggregate data were used because individual-level geospatial information is not available from NDB Open Data. The analysis used the **10th NDB Open Data** release: fracture procedure counts from **Reiwa 5** (April 2023 through March 2024) claims and Specific Health Checkup walking-speed aggregates from **Reiwa 4** (April 2022 through March 2023), per Ministry of Health, Labour and Welfare documentation.
...
**Figure 3.** Prefectural distribution of habitable-area-weighted terrain slope (degrees) across Japan. Darker shading indicates steeper terrain. Prefectures in the Chugoku, Shikoku, and Kyushu mountain ranges show the highest slope values.

**Figure 4.** Prefectural distribution of hip fracture surgery rate (per 100,000 population) across Japan. Darker shading indicates higher rates. Prefectures in mountainous regions tend to show elevated rates.
