...
All manuscript figures were generated programmatically from study data using reproducible Python workflows: Python 3.14.2 with `pandas` 2.3.3, `numpy` 2.3.5, `matplotlib` 3.10.8, `seaborn` 0.13.2, `scipy` 1.16.3, `geopandas` 1.1.2, and `japanize_matplotlib` 1.1.3. Figure 1 was generated via linear-fit visualization from the prefecture-level analytical dataset, Figure 2 from the corresponding correlation matrix, and Figures 3-5 by joining prefecture-level indicators to national prefectural boundary geodata and rendering choropleth maps.
