...
This ecological study showed a positive association between prefectural-level terrain slope and hip fracture surgery rates after adjustment for proportion aged ≥65 years, fast-walking proportion, and population density (β = 3.49 per one-degree increase; conventional 95% CI, 0.11–6.86; *p* = 0.043), while acknowledging that heteroskedasticity-robust and bootstrap intervals for the slope coefficient were compatible with no association at α = 0.05. After the same adjustment, each additional degree of slope corresponded to approximately 3.5 additional hip fracture surgeries per 100,000 population under the primary OLS parameterization. The adjusted association was specific to hip fractures and was not observed for humerus or forearm fractures. Figure 2 maps prefectural distributions of terrain slope, hip fracture surgery rates, and their joint classification. Residence in prefectures with steeper habitable terrain may be associated with greater hip-specific surgical burden. This ecological association persisted beyond compositional aging and self-reported walking pace, although individual-level fracture incidence cannot be inferred.
...
We linked terrain and health indicators at the prefecture level—the finest resolution available for all 47 prefectures in public NDB Open Data without residential geocoding.[49] Ecological associations may not reflect individual-level relationships. Residents of steep prefectures may live chiefly in low-slope basins rather than in remote mountainous terrain, which can misclassify terrain exposure. Fracture surgery counts (Reiwa 5), Specific Health Checkup walking-speed tabulations (Reiwa 4), and 2020 census denominators were not temporally co-extensive; we therefore interpreted results as an administrative snapshot rather than a harmonized single-year cohort.

Outcomes were hip fracture surgery rates, not fracture incidence. Although hip fractures are usually treated surgically, prefectural variation in treatment, referral, and access to operative care may have influenced observed rates. The cross-sectional design precluded causal inference; although reverse causation was unlikely for fixed terrain, residual confounding by unmeasured contextual factors (e.g., healthcare access, climate, osteoporosis treatment) could not be excluded. With only 47 units, inference for the primary slope coefficient was borderline in heteroskedasticity-robust and bootstrap analyses (Results); findings should be interpreted as hypothesis-generating for place-based health geography.

## 9. Future research directions

Building on this nationwide open-data linkage, priority extensions include individual-level cohorts with residential geocoding and objective daily terrain exposure (e.g., GPS, accelerometry). Finer-scale GIS could quantify municipal or neighborhood DEM-based slope and fall-relevant micro-environments (pathways, stairs, snowfall, icing). Linkage to prescription and bone-density screening data, and sex- and age-stratified outcomes when finer NDB releases permit, would improve confounding control. Objectively measured gait and travel mode could test mechanisms discussed in the walking-speed section. Longitudinal harmonization of claims, screening, and census years would strengthen causal inference. Such work could clarify whether terrain slope relates to hip fracture burden through biomechanical fall risk, functional decline, or correlated healthcare and social contexts in Japan's aging mountainous regions.

---

# Conclusions

In this nationwide ecological study, residence in prefectures with steeper habitable terrain was suggestively associated with higher hip fracture surgery rates after adjustment for proportion aged ≥65 years, fast-walking proportion, and population density. No similar pattern was observed for humerus or forearm surgery rates. Outcomes were administrative surgery rates rather than fracture incidence. Given *N* = 47 prefectures and borderline inferential sensitivity in robustness analyses, findings should be interpreted as hypothesis-generating for health geography and environment-aware fall-prevention planning in mountainous regions.

Habitable-area-weighted slope aligned topography with populated land (Methods) and provided a reproducible Japan-wide linkage between open administrative data and hip-specific surgical burden. These results did not establish individual causal effects of slope exposure but may support regional burden mapping and environment-specific prevention in high-slope communities.

---

# Data availability

The prefecture-level aggregated analytical dataset (N = 47) and statistical analysis code supporting this study will be deposited in Zenodo (reserved DOI: 10.5281/zenodo.XXXXXXX; https://zenodo.org/record/XXXXXXX). The dataset compiles variables from publicly available administrative sources cited in the Methods: the 10th National Database (NDB) Open Data (Reiwa 5 health insurance claims for fracture surgery counts; Reiwa 4 Specific Health Checkup tabulations for walking speed), the 2020 National Census (population denominators and covariates), and Geospatial Information Authority of Japan geodata for terrain slope. Under Ministry of Health, Labour and Welfare distribution rules, individual-level claims and identifiable records cannot be shared; prefecture-level values from those public releases can also be reproduced using the procedures in the deposited code and documentation. Author contributions are reported on the separate title page required for double-anonymized submission (CRediT taxonomy).
