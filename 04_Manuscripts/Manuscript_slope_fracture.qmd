...
We conducted an ecological study of 47 Japanese prefectures using the 10th National Database (NDB) Open Data. Fracture surgery rates (per 100,000) were derived from **Reiwa 5 fiscal year** (April 2023 through March 2024) health insurance claims; the fast walking covariate came from **Reiwa 4 fiscal year** (April 2022 through March 2023) Specific Health Checkup tabulations included in the same release (Ministry of Health, Labour and Welfare). Terrain slope was derived from 10-m digital elevation models (habitable-area weighted). Other covariates were aging rate and population density (2020 National Census). We used unadjusted and multivariable ordinary least squares (OLS) regression with residual diagnostics and sensitivity analyses (heteroskedasticity-robust HC3 standard errors; nonparametric bootstrap resampling of prefectures, *B* = 5,000).

## Results

Mean slope was 8.57 degrees (SD 3.16); mean hip fracture rate was 254.0 per 100,000 (SD 37.6). Slope was positively associated with hip fracture rate unadjusted (β = 5.65; 95% CI, 2.50–8.79; R² = 0.225; *p* = 0.001). After adjustment, the slope coefficient was 3.49 (95% CI, 0.11–6.86; *p* = 0.043) under conventional OLS standard errors; HC3 robust inference yielded *p* = 0.063 and a bootstrap 95% CI of −0.03 to 7.09, indicating borderline statistical support at *N* = 47 prefectures. Associations were absent for humerus and forearm fractures.

## Conclusions

Prefecture-level terrain slope showed a positive adjusted association with hip fracture surgery rates in primary OLS, with fracture-site specificity consistent with lateral-fall mechanisms; however, inferential sensitivity at small ecological *N* warrants cautious interpretation. Individual-level studies should confirm these findings.
