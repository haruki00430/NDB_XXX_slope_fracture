...
The derived prefecture-level analytical dataset and analysis code supporting this study will be deposited in Zenodo (reserved DOI: 10.5281/zenodo.XXXXXXX; https://zenodo.org/record/XXXXXXX). Primary administrative indicators were obtained from publicly available sources cited in the Methods: the 10th National Database (NDB) Open Data (Reiwa 5 health insurance claims for fracture surgery counts; Reiwa 4 Specific Health Checkup tabulations for walking speed), the 2020 National Census (population denominators and covariates), and Geospatial Information Authority of Japan geodata for terrain slope. Under Ministry of Health, Labour and Welfare distribution rules, individual-level claims and identifiable records cannot be shared; prefecture-level values from those public releases can be reproduced using the procedures described. Author contributions are reported on the separate title page required for double-anonymized submission (CRediT taxonomy).
