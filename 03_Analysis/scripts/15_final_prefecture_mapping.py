# -*- coding: utf-8 -*-
"""
メッシュ座標から都道府県を特定（最終版：メッシュ範囲全体で判定）
"""
...
pref_ranges = {
    ...
    '東京都': {'lat': (20.0, 36.0), 'lon': (136.0, 154.0)},
...
# 結果を保存
output_file = r"c:\Users\user\SharedWorkspace\projects\NDB_Research_Hub\projects\NDB_XXX_slope_fracture\03_Analysis\data\interim\mesh_prefecture_mapping_final.csv"
result_df.to_csv(output_file, index=False, encoding='utf-8')

# レポート作成
report_lines = []
report_lines.append("=== G04-c メッシュの都道府県カバレッジ（最終版：範囲重複判定） ===\n")
...
# レポートを保存
report_file = r"c:\Users\user\SharedWorkspace\projects\NDB_Research_Hub\projects\NDB_XXX_slope_fracture\03_Analysis\data\interim\prefecture_coverage_report_final.txt"
